//! Context and position tracking for the winnow string parser
...
pub struct ParseContext<'a> {
    ...
    pub pending_heredoc_trailing: &'a RefCell<Option<&'a str>>,
}
...
impl PositionTracker {
    ...
    #[inline]
    pub fn offset_from_locating(&self, input: &LocatingSlice<&str>) -> usize {
    ...
    #[inline]
    pub fn range_to_span(&self, range: std::ops::Range<usize>) -> SourceSpan {
        SourceSpan {
